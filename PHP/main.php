            ...
            <div class='content'>
                ...
                <form method='post' action='login_register/checkLogin.php' class='loginform'>
                    <fieldset class='loginfieldset'>
                        ...
                        <!--아이디-->
                        아이디<br><input type='text' name='ID' placeholder='ID를 입력하세요.' class='modalinput'><br><br>
                        <!--비밀번호-->
                        비밀번호 <br><input type='password' name='PW' id='PW' placeholder='비밀번호를 입력하세요.' class='modalinput'><br><br>
                        <hr>
                        <!--회원가입 버튼-->
                        <input type='submit' value='로그인' class='modalbtn'>
                        <input type='button' onclick='location.href=\"./signup.php\"' value='회원가입' class='modalbtn'>
                    </fieldset>
                </form>
            </div>
        </div>
                ...
                <fieldset class="slidewrap">
                    <ul class="slidelist">
                        ...
                        <li class="slideitem">
                            <div class="textbox">
                                <h3>시작하기</h3>
                                <p><a></a>다음은 <a class="name"></a> 회원님의 신체 정보입니다.<br>수정이 필요하신 경우 수정하신 후 오른쪽 화살표를
                                    클릭해주세요.</p>
                                <div>나이 : <input type="number" name="age" id="age"
                                        value="<?php echo $_SESSION['age']; ?>">
                                    <!--value 부분에 나이-->
                                    <a>&nbsp; 살</a><br>
                                    &nbsp;&nbsp;&nbsp;&nbsp; 키 : <input type="number" name="height" id="height"
                                        value="<?php echo $_SESSION['height']; ?>" step="0.1">
                                    <!--value부분에 키-->
                                    <a>&nbsp; cm</a><br>
                                    체중 : <input type="number" name="weight" id="weight"
                                        value="<?php echo $_SESSION['weight']; ?>" step="0.1">
                                    <!--value부분에 몸무게-->
                                    <a>&nbsp; kg</a><br>
                                    <div class="radio">
                                        <a>성별 : </a>
                                        <!--이부분에 성별-->
                                        <span id="sex">남성</span>
                                        <input type="radio" name="sex" value="남성" <?php if ($_SESSION['sex'] == '남성')
                                            echo "checked"; ?> />
                                        <span id="sex">여성</span>
                                        <input type="radio" name="sex" value="여성" <?php if ($_SESSION['sex'] == '여성')
                                            echo "checked"; ?> />
                                    </div>
                                </div>
                            </div>
                            ...
                            <a>
                                ...
                                <div class="textbox">
                                    ...
                                    <ul>
                                        ...
                                        <li>키는 <a class="resultHeight"></a> cm, 체중은 <a class="resultWeight"></a> kg
                                        </li>
